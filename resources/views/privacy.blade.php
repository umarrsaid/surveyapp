...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>IFField | Privacy Policy</title>
					...
					<div class="page-header">
						<div class="page-header-top">
							<div class="container-fluid text-center">
										<img src="{{asset('assets/layout/img/logo-app-header2.png')}}" alt="logo" class="logo-default" style="margin-top:15px;">
							</div>
						</div>
											...
											<div class="col-md-6">
												<div class="portlet box blue">
                                                    <div class="portlet-title">
                                                        <div class="caption"><h1>Privacy Policy</h1></div>
                                                    </div>
...
<p>IFF Field ("us", "we", or "our") operates the http://iff-field.solusiteknis.com/ website and the IFF Field mobile application (hereinafter referred to as the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. The Privacy Policy  for IFF Field has been created with the help of <a href="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
...
<ul>
    <li>
        <p><strong>Service</strong></p>
                <p>Service means the http://iff-field.solusiteknis.com/ website and the IFF Field mobile application operated by IFF Field</p>
            </li>
    <li>
...
<p>IFF Field uses the collected data for various purposes:</p>    
<ul>
...
<p>IFF Field will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>IFF Field may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of IFF Field</li>
...
<ul>
        <li>By email: software@grit-tekno.com</li>
